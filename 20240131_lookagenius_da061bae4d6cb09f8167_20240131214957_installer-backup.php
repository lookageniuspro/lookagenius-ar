...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20240131_lookagenius_da061bae4d6cb09f8167_20240131214957_archive.zip';
        const ARCHIVE_SIZE       = '34139979';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = 'da061ba-31214957';
        const SECONDARY_PACKAGE_HASH = 'cec1575-31214957';
        const VERSION            = '1.5.8';
